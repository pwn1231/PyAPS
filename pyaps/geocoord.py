...
class PyAPS_geo:
	...
	def getlindelay(self,dataobj,inc=0.0,wvl=4*np.pi):
		'''Write delay to a matrix / HDF5 object or a file directly. LinearNDInterpolator is used and is not very stable.
	...
	def getdelay(self,dataobj,inc=None,wvl=4*np.pi):
